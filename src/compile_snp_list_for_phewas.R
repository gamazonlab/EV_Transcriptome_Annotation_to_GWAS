...
write.table(gwas_cat, file = "/home/bettimj/gamazon_rotation/obesity_corebed/phewas/phewas_corebed_snps_obesity.txt", sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)
